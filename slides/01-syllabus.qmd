...
```
  + I will **NOT** reply your e-mail if ... **Check the email policy in the [syllabus](https://math3570-s24.github.io/website/course-syllabus.html)**!
...
`r emo::ji("x")` If you do **NOT** want to learn **R and/or Python**, do **NOT** take this course! (3570 is offered **every** semester)
...
- `r emo::ji("x")` **No make-up homework** for any reason unless you got [COVID](https://www.marquette.edu/central/registrar/faculty-staff/guidance-on-fall-2023-class-attendance-withdrawal-grading.php) or [excused absence](https://bulletin.marquette.edu/undergrad/academicregulations/#attendance). `r emo::ji("pray")`
